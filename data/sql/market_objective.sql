...
(select
day,
'sum_by_marketing_objective' as table,
count(*) as num_rows,
...
'0' as num_group_id,
'0' as num_channel_id,
count(distinct objective_id) as num_objective_id,
'0' as num_domain
...
from summarydata.sum_by_marketing_objective_by_day	join advertisers using(advertiser_id)
...
,'0' as raw_existing_site_visitors
,'0'  as  raw_new_site_visitors
,'0' as  visitors
from summarydata.sum_by_marketing_objective_by_day	join advertisers using(advertiser_id)
where day>='2023-02-23' and day<'2023-03-01'
group by 1 order by 1 )
