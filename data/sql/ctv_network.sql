...
(select
day,
'sum_by_ctv_network' as table,
count(*) as num_rows,
count(distinct advertiser_id) as num_advertiser_id,
count(distinct campaign_id) as num_campaign_id,
...
from summarydata.sum_by_ctv_network_by_day join advertisers using(advertiser_id)
