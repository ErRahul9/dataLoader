...
(select
day,
'sum_by_campaign_group' as table,
count(*) as num_rows,
count(distinct advertiser_id) as num_advertiser_id,
'0' as num_campaign_id,
count(distinct campaign_group_id) as num_campaign_group_id,
...
from summarydata.sum_by_campaign_group_by_day	join advertisers using(advertiser_id)
